...
export default function App() {
  ...
  const sharedProps = {
    ccaaCode : geo.ccaaCode,
    ccaaName : geo.ccaaName,
        ...
        <div style={{maxWidth:1100,margin:'0 auto',display:'flex',alignItems:'center',gap:'1rem',height:54}}>
          ...
          {location && (
            <div style={{display:'flex',alignItems:'center',gap:6,fontSize:13,flexWrap:'wrap'}}>
              ...
              {location.ccaaName && <span style={{color:'var(--text3)',fontSize:12}}>{location.ccaaName}</span>}
              {location.ccaaName && <span style={{color:'var(--text3)'}}>›</span>}
